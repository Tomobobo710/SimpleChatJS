        ...
        },
        {
            ...
            input_schema: {
                ...
                properties: {
                    ...
                    background: { type: 'boolean', description: 'Optional. Run the command in the background: returns immediately with a job_id instead of blocking for completion. No timeout applies in this mode. Use job_list/job_output/job_kill to manage it afterward.' }
                },
                required: ['command'],
                additionalProperties: false
            }
